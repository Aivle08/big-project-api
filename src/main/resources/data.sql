...
-- Users 테이블 데이터 삽입
INSERT INTO users (username, password, name, email, position, department_id, contact)
VALUES
    ('johndoe', 'securepassword', 'John Doe', 'johndoe@example.com', 'Manager', 1, '111-1111-11111'),
    ('janedoe', 'password123', 'Jane Doe', 'janedoe@example.com', 'HR Specialist', 2, '111-1111-11111'),
    ('samsmith', 'password456', 'Sam Smith', 'samsmith@example.com', 'Developer', 3, '111-1111-11111'),
    ('mikejohnson', 'mypassword', 'Mike Johnson', 'mikejohnson@example.com', 'Marketing Lead', 4, '111-1111-11111'),
    ('emilydavids', 'admin123', 'Emily Davids', 'emilydavids@example.com', 'Finance Officer', 5, '111-1111-11111');
